...
plt.savefig(f"regression_{hparams["nodes"]}_{hparams["layers"]}_{epochs}_{args.scheduler}.png", dpi=300)
# plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(f"loss_curve_{hparams["nodes"]}_{hparams["layers"]}_{epochs}_{args.scheduler}.png", dpi=300)
# plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(f"lr_curve_{hparams["nodes"]}_{hparams["layers"]}_{epochs}_{args.scheduler}.png", dpi=300)
