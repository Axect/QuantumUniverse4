...
plt.savefig(f"regression_{hparams["nodes"]}_{hparams["layers"]}_{epochs}.png", dpi=300, bbox_inches='tight')
# plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(f"loss_curve_{hparams["nodes"]}_{hparams["layers"]}_{epochs}.png", dpi=300, bbox_inches='tight')
# plt.show()
